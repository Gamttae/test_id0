...
(function () {
  ...
  // Loading brackets → converge to center dot → expand to main scene
  // ═══════════════════════════════════════════════════════════
  function startBracketTransition() {
    ...
    // Step 1: Fade out loading screen
    $loading.classList.add('fade-out');

    setTimeout(() => {
      $loading.style.display = 'none';

      // Step 2: Show bracket transition overlay (white bg with two brackets)
      $bracketTransition.style.display = 'block';

      // Start brackets at center (dot)
      $transTL.classList.add('phase-center');
      $transBR.classList.add('phase-center');

      // Step 3: After brief pause, expand brackets to final main scene positions
      setTimeout(() => {
        ...
        // Step 4: Fade out bracket overlay, show main scene
        setTimeout(() => {
